...
function BoardDetail() {
  ...
  useEffect(() => {
    axios
      .get(`https://13.53.74.46:8443/board/${id}`, { withCredentials: true })
  ...
  useEffect(() => {
    axios
      .get(`https://13.53.74.46:8443/board/${id}/check`, { withCredentials: true })
  ...
  const handleSave = () => {
    axios
      .put(
        `https://13.53.74.46:8443/board/${id}`,
  ...
  const handleDelete = () => {
    if (window.confirm("삭제하시겠습니까?")) {
      axios
        .delete(`https://13.53.74.46:8443/board/${id}`, { withCredentials: true })
